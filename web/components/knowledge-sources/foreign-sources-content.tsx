// components/knowledge-sources/foreign-sources-content.tsx
"use client";
...
interface ForeignSourcesContentProps {
  dictionary: AppDictionary;
  lang: string;
}

export function ForeignSourcesContent({ dictionary, lang }: ForeignSourcesContentProps) {
  const partners = getActivePartners('foreign');

  return (
    <div className={`min-h-screen bg-background ${lang === "ar" ? "rtl" : "ltr"}`}>
      {/* Header */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/20 dark:to-purple-900/20">
        <div className="container px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-sm font-medium mb-6">
              ...
              {dictionary.knowledgeSources.foreignSources.title}
            </div>
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              {dictionary.knowledgeSources.foreignSources.description}
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container px-4">
          {partners.length === 0 ? (
            ...
            >
              <div className="mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {dictionary.knowledgeSources.foreignSources.comingSoon}
                </h2>
                
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                  {dictionary.knowledgeSources.foreignSources.comingSoonDescription}
                </p>
              </div>
            ...
            <div>
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {dictionary.knowledgeSources.foreignSources.partners}
                </h2>
